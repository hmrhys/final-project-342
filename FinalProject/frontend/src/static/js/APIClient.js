...
// create new user
const createUser = (first_name, last_name, username, password) => { //, pwd_salt, avatar) => {
    console.log("Entering APIClient");
    console.log("Creating user...");
    // pass in rest of data
    const data = {
        // userId: userId,
...
const getGameReviews = (guid) => {
    return HTTPClient.get(`${API_BASE}/games/${guid}/reviews`);
};
...
// create new review
const createReview = (gameId, score, hoursPlayed, date, text, uid) => {
    const data = {
        game_id: gameId,
        score: score,
